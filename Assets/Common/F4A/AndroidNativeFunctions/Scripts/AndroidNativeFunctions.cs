...
public class AndroidNativeFunctions : MonoBehaviour
{
    ...
    public static string[] GetAndroidEmailAccounts()
    {
        if (Application.platform == RuntimePlatform.Android)
        {
    ...
    public static string GetNetworkOperatorName()
    {
        ...
        if (Application.platform == RuntimePlatform.Android)
        {
            AndroidJavaClass cls = new AndroidJavaClass("com.example.jarpluginunity.TelePhonyUtils");
            return cls.CallStatic<string>("getNetworkOperatorName", currentActivity);
        }
        else
        {
            return "";
    ...
    public static string GetNetworkCountryIso()
    {
        ...
        {
            AndroidJavaClass cls = new AndroidJavaClass("com.example.jarpluginunity.TelePhonyUtils");
            return cls.CallStatic<string>("getNetworkCountryIso", currentActivity);
        }
        else
        {
            return "";
    ...
    public static string GetSimCountryIso()
    {
        ...
        {
            AndroidJavaClass cls = new AndroidJavaClass("com.example.jarpluginunity.TelePhonyUtils");
            return cls.CallStatic<string>("getSimCountryIso", currentActivity);
        }
        else
        {
            return "";
    ...
    /// <returns></returns>
    public static string GetAllSMS(string folder)
    {
        if (Application.platform == RuntimePlatform.Android)
        {
            AndroidJavaClass cls = new AndroidJavaClass("com.example.jarpluginunity.TelePhonyUtils");
            return cls.CallStatic<string>("getAllSms", currentActivity, folder);
        }
        else
        {
            return null;
    ...
    public static bool SendMessage(string phone, string contentsms)
    {
        if (Application.platform != RuntimePlatform.Android)
        {
            return false;
        ...
        {
            AndroidJavaClass cls = new AndroidJavaClass("com.example.jarpluginunity.TelePhonyUtils");
            cls.CallStatic("sendSMS", phone, null, contentsms, null, null);
            return true;
        }
    }

    public static void RegisterBroadcastReceiverSms(string serviceProviderNumber, string serviceProviderSmsCondition)
    {
        if (Application.platform != RuntimePlatform.Android)
        {
            return;
        ...
        AndroidJavaClass cls = new AndroidJavaClass("com.example.jarpluginunity.TelePhonyUtils");
        cls.CallStatic("registerBroadcastReceiverSms", currentActivity, serviceProviderNumber, serviceProviderSmsCondition);
    }

    public static void UnregisterBroadcastReceiverSms()
    {
        if (Application.platform != RuntimePlatform.Android)
        {
            return;
        ...
        AndroidJavaClass cls = new AndroidJavaClass("com.example.jarpluginunity.TelePhonyUtils");
        cls.CallStatic("unregisterBroadcastReceiverSms", currentActivity);
    }
    ...
    public static string GetAndroidExternalFilesDir()
    {
        ...
        try
        {
            ...
            //AndroidJavaObject[] externalFilesDirectories = currentActivity.Call<AndroidJavaObject[]>("getExternalFilesDirs");
            AndroidJavaObject[] externalFilesDirectories = currentActivity.Call<AndroidJavaObject[]>("getExternalFilesDirs");
            ...
            if (sdCard != null) return sdCard.Call<string>("getAbsolutePath");
            else return emulated.Call<string>("getAbsolutePath");
        }
        catch (Exception ex)
        {
            Debug.LogError("AndroidNativeFunctions.GetAndroidExternalFilesDir ex:" + ex);
        ...
        //                path = "/data/data/com.game2019.tileshop/files";
        //            }
        //        }
        //    }
        //}
