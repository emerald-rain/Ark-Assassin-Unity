namespace com.F4A.MobileThird
{
    ...
    public enum EBannerAdNetwork : int
    {
    ...
    public enum EInterstitialAdNetwork : int
    {
        None = EAdNetwork.None,
    ...
    public enum EVideoAdNetwork : int
    {
        None = EAdNetwork.None,
        UnityAds = EAdNetwork.UnityAds,
        AdMob = EAdNetwork.AdMob,
    ...
    public enum ERewardedAdNetwork : int
    {
        None = EAdNetwork.None,
        AdColony = EAdNetwork.AdColony,
        AdMob = EAdNetwork.AdMob,
    ...
    public enum EFirebaseEventAnalytic : int
    {
        EventPostScore,
        EventLogin,
        EventLevelUp,
