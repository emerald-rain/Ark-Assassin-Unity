...
namespace com.F4A.MobileThird
{
    ...
    public class F4ASocialSettingInfo
    {
        ...
        public string[] facebookQueryFields = { "id", "email", "name", "first_name", "last_name" };
    ...
    public partial class SocialManager : SingletonMono<SocialManager>
	{
        ...
        internal void ShareTwitter()
        {
            ...
            + " #Playing #Free #Music #Game #Awesome #Fun #Trending #Trend #" + BuildManager.Instance.GetCompanyName();
        ...
        public void SaveInfo()
        {
            ...
            string path = Application.dataPath + "/Common/Data/SocialInfo.txt";
